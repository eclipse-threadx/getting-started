...
1. Connect the device:
    * Connect the **WiFi module** to the **Cloud Option Board**
    * Connect **CN18** on the **Cloud Option Board** to your computer
    * Connect **ECN1** on the **Target Board** to your computer
    * Remove the **EJ2 link** from the **Target Board**
