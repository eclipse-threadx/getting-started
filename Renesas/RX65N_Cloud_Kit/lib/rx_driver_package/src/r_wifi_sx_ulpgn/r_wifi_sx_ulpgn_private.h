...
#if 0
#define EXECUTE_COMMAND_TIMEOUT_DEFAULT1 10000
#define EXECUTE_COMMAND_TIMEOUT_DEFAULT2 1000
#define EXECUTE_COMMAND_TIMEOUT_DEFAULT3 20000
#define EXECUTE_COMMAND_TIMEOUT_DEFAULT4 3000
#define EXECUTE_COMMAND_TIMEOUT_DEFAULT5 15000
#else
...
#if defined(__CCRX__) || defined(__ICCRX__) || defined(__RX__)
#define WIFI_CFG_TASK_PRIORITY ( 5 )
#endif
#if defined(__CCRL__) || defined(__ICCRL78__) || defined(__RL)
#define WIFI_CFG_TASK_PRIORITY ( tskIDLE_PRIORITY )
#endif
...
typedef struct wifi_socket_tag
{
	...
	ULONG send_starttime;
	ULONG send_thistime;
	ULONG send_endtime;
	ULONG recv_starttime;
	ULONG recv_thistime;
    ULONG recv_endtime;
