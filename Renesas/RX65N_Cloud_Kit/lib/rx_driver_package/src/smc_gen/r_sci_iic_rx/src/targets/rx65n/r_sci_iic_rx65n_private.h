...
/* Guards against multiple inclusion */
    ...
    #define SCI_IIC_RX65N_PRIVATE_H
/***********************************************************************************************************************
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #define SCI_IIC_MPC_SSDA9_ENABLE    ((uint8_t)(0x0A))   /* Pin function select to SCI9 SSDA pin:b01010 */
            #define SCI_IIC_MPC_SSCL9_ENABLE    ((uint8_t)(0x0A))   /* Pin function select to SCI9 SSCL pin:b01010 */
        #endif /* #ifdef SCI_IIC_CFG_CH9_INCLUDED */

        #if SCI_IIC_CFG_CH10_INCLUDED
            #if ((SCI_IIC_CFG_CH10_SSDA_GP == PORTC_GR) && (SCI_IIC_CFG_CH10_SSDA_PIN == 7))
                #define SCI_IIC_MPC_SSDA10_ENABLE ((uint8_t)(0x24))  /* Pin function select to SCI10 SSDA pin:b100100 */
            #else
                #define SCI_IIC_MPC_SSDA10_ENABLE ((uint8_t)(0x0A))  /* Pin function select to SCI10 SSDA pin:b001010 */
            #endif
            #if ((SCI_IIC_CFG_CH10_SSCL_GP == PORTC_GR) && (SCI_IIC_CFG_CH10_SSCL_PIN == 6))
                #define SCI_IIC_MPC_SSCL10_ENABLE ((uint8_t)(0x24))  /* Pin function select to SCI10 SSCL pin:b100100 */
            #else
                #define SCI_IIC_MPC_SSCL10_ENABLE ((uint8_t)(0x0A))  /* Pin function select to SCI10 SSCL pin:b001010 */
            #endif
        #endif /* #ifdef SCI_IIC_CFG_CH10_INCLUDED */

        #if SCI_IIC_CFG_CH11_INCLUDED
            #if ((SCI_IIC_CFG_CH11_SSDA_GP == PORTB_GR) && (SCI_IIC_CFG_CH11_SSDA_PIN == 7))
                #define SCI_IIC_MPC_SSDA11_ENABLE ((uint8_t)(0x24))  /* Pin function select to SCI11 SSDA pin:b100100 */
            #else
                #define SCI_IIC_MPC_SSDA11_ENABLE ((uint8_t)(0x0A))  /* Pin function select to SCI11 SSDA pin:b001010 */
            #endif
            #if ((SCI_IIC_CFG_CH11_SSCL_GP == PORTB_GR) && (SCI_IIC_CFG_CH11_SSCL_PIN == 6))
                #define SCI_IIC_MPC_SSCL11_ENABLE ((uint8_t)(0x24))  /* Pin function select to SCI11 SSCL pin:b100100 */
            #else
                #define SCI_IIC_MPC_SSCL11_ENABLE ((uint8_t)(0x0A))  /* Pin function select to SCI11 SSCL pin:b001010 */
            #endif
        #endif /* #ifdef SCI_IIC_CFG_CH11_INCLUDED */
