...
1. Select **Default component**. Azure IoT Explorer displays the IoT Plug and Play components that are implemented on your device.
...
In this tutorial you used Azure IoT Explorer to work with an IoT Plug and Play-enabled device. You use Azure IoT Explorer to add an IoT Plug and Play device model. Then you used the UI generated by Azure IoT Explorer to work with device properties, view telemetry, and invoke a direct method to toggle the LED.
