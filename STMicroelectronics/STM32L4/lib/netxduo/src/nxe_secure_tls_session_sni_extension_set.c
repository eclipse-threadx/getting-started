...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nxe_secure_tls_session_sni_extension_set           PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function checks for errors when setting the TLS Server Name    */
/*    Indication name for a TLS client.                                   */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
UINT status;
    ...
    /* Set the name in the TLS session. */
    status = _nx_secure_tls_session_sni_extension_set(tls_session, dns_name);
