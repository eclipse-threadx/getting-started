...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nxe_secure_tls_session_time_function_set           PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function checks for errors when setting the TLS time function. */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
UINT status;
    ...
    status = _nx_secure_tls_session_time_function_set(tls_session, time_func_ptr);
