/**
  ...
  *          USER push-button
  *          COM port
  *          available on B_U585I_IOT02A board(MB1551) from STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup B_U585I_IOT02A_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup B_U585I_IOT02A_COMMON_Private_Defines B_U585I_IOT02A COMMON Private Defines
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_COMMON_Private_Macros B_U585I_IOT02A COMMON Private Macros
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_LOW_LEVEL_Private_TypesDefinitions LOW LEVEL Private Types Definitions
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_LOW_LEVEL_Private_FunctionPrototypes  LOW LEVEL Private Function Prototypes
  * @{
  */
...
/** @defgroup B_U585I_IOT02A_LOW_LEVEL_Exported_Functions LOW LEVEL Exported Functions
  * @{
  */

/**
  * @brief  This method returns the B_U585I_IOT02A BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return (int32_t)B_U585I_IOT02A_BSP_VERSION;
}
...
{
  return (uint8_t *)B_U585I_IOT02A_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)B_U585I_IOT02A_BSP_BOARD_ID;
}
