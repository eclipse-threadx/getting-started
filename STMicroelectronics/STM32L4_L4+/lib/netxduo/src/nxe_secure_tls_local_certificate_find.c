...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nxe_secure_tls_local_certificate_find              PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function checks for errors in the TLS local certificate find   */
/*    call.                                                               */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
UINT status;
    ...
    status = _nx_secure_tls_local_certificate_find(tls_session, certificate, common_name, name_length);
