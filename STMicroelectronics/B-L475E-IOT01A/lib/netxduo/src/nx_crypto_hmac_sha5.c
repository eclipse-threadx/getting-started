...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nx_crypto_method_hmac_sha512_init                  PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*    Express Logic supported HMAC SHA512 cryptograhic algorithm.         */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
NX_CRYPTO_KEEP UINT  _nx_crypto_method_hmac_sha512_init(struct  NX_CRYPTO_METHOD_STRUCT *method,
                                                        ...
                                                        ULONG crypto_metadata_size)
{
    ...
    if(crypto_metadata_size < sizeof(NX_CRYPTO_SHA512_HMAC))
    {
        return(NX_CRYPTO_PTR_ERROR);
    }
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nx_crypto_method_hmac_sha512_cleanup               PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Timothy Stapko, Microsoft Corporation                               */
...
/*                                                                        */
/**************************************************************************/
NX_CRYPTO_KEEP UINT  _nx_crypto_method_hmac_sha512_cleanup(VOID *crypto_metadata)
{
    ...
    NX_CRYPTO_MEMSET(crypto_metadata, 0, sizeof(NX_CRYPTO_SHA512_HMAC));
#else
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nx_crypto_method_hmac_sha512_operation             PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
/*    Timothy Stapko, Microsoft Corporation                               */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function handles HMAC SHA512 Authentication operation.         */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
/*    op                                    Operation Type                */
...
/*                                                                        */
/**************************************************************************/
NX_CRYPTO_KEEP UINT  _nx_crypto_method_hmac_sha512_operation(UINT op,      /* Encrypt, Decrypt, Authenticate */
...
NX_CRYPTO_SHA512_HMAC  *ctx;
NX_CRYPTO_HMAC         *hmac_metadata;
UINT                    icv_full_length;
    ...
    if (method -> nx_crypto_algorithm == NX_CRYPTO_AUTHENTICATION_HMAC_SHA2_512)
    {
        icv_full_length = NX_CRYPTO_HMAC_SHA512_ICV_FULL_LEN_IN_BITS;
    }
    else if (method -> nx_crypto_algorithm == NX_CRYPTO_AUTHENTICATION_HMAC_SHA2_384)
    {
        icv_full_length = NX_CRYPTO_HMAC_SHA384_ICV_FULL_LEN_IN_BITS;
    }
    else if (method -> nx_crypto_algorithm == NX_CRYPTO_AUTHENTICATION_HMAC_SHA2_512_224)
    {
        icv_full_length = NX_CRYPTO_HMAC_SHA512_224_ICV_FULL_LEN_IN_BITS;
    }
    else if (method -> nx_crypto_algorithm == NX_CRYPTO_AUTHENTICATION_HMAC_SHA2_512_256)
    {
        icv_full_length = NX_CRYPTO_HMAC_SHA512_256_ICV_FULL_LEN_IN_BITS;
    }
    else
    {
    ...
    ctx = (NX_CRYPTO_SHA512_HMAC *)crypto_metadata;
    hmac_metadata = &ctx->nx_sha512_hmac_metadata;

    _nx_crypto_hmac_metadata_set(hmac_metadata,
                                 &(ctx -> nx_sha512_hmac_context),
                                 method -> nx_crypto_algorithm,
                                 NX_CRYPTO_SHA512_BLOCK_SIZE_IN_BYTES,
                                 icv_full_length >> 3,
                                 (UINT (*)(VOID *, UINT))_nx_crypto_sha512_initialize,
                                 (UINT (*)(VOID *, UCHAR *, UINT))_nx_crypto_sha512_update,
                                 (UINT (*)(VOID *, UCHAR *, UINT))_nx_crypto_sha512_digest_calculate);
