...
static const UINT output_size[] = {128, 256, 512};
static const UINT key_size[] = {1024, 2048, 4096};
static const UCHAR *pub_e[] = {pub_e_1024, pub_e_2048, pub_e_4096};
static const UCHAR *pri_e[] = {pri_e_1024, pri_e_2048, pri_e_4096};
static const UCHAR *m[] = {m_1024, m_2048, m_4096};
static const UCHAR *p[] = {p_1024, p_2048, p_4096};
static const UCHAR *q[] = {q_1024, q_2048, q_4096};
static const UCHAR *plain[] = {plain_1024, plain_2048, plain_4096};
static const UCHAR *secret[] = {secret_1024, secret_2048, secret_4096};
...
VOID *handler = NX_NULL;
    ...
    for (i = 0; i < sizeof(output_size) / sizeof(UINT); ++i)
    {
        ...
        if (NX_SECURE_MEMCMP(output, secret[i], output_size[i]) != 0)
        {
        ...
        if (NX_SECURE_MEMCMP(output, plain[i], output_size[i]) != 0)
        {
            return(NX_NOT_SUCCESSFUL);
        }
