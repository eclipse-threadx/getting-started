...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _nx_secure_tls_session_server_callback_set          PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*    invoke when the TLS server receives a ClientHello message from the  */
                                                                  ...
                                                                  UINT num_extensions))
{
    ...
    tls_session -> nx_secure_tls_session_server_callback = func_ptr;
