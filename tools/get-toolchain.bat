...
set cmake_path=https://github.com/Kitware/CMake/releases/download/v3.18.3
set cmake_file=cmake-3.18.3-win32-x86.msi
set cmake_name=CMake v3.18.3
...
echo.
echo Installation complete! Successfully installed CMake, GCC-ARM, Termite and Azure IoT Explorer.
echo.
