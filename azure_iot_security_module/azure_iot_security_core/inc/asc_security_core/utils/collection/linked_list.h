...
typedef struct linked_list_##type##_tag {\
    type* head;\
    type* tail;\
    uint32_t size;\
...
typedef struct linked_list_iterator_##type##_tag {\
    type* current;\
    type* next;\
...
type* linked_list_##type##_remove_first(linked_list_##type##_handle linked_list);\
type* linked_list_##type##_add_last(linked_list_##type##_handle linked_list, type* item);\
type* linked_list_##type##_remove_last(linked_list_##type##_handle linked_list);\
