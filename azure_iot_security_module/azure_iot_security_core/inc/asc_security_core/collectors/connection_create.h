...
#ifndef _COLLECTOR_CONNECTION_CREATE_H
#define _COLLECTOR_CONNECTION_CREATE_H

#include "asc_security_core/model/collector.h"

/**
 * @brief Initialize ConnectionCreate Collector
 *
...
#endif /* _COLLECTOR_CONNECTION_CREATE_H */
