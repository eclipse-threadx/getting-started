...
#ifndef MESSAGE_SCHEMA_CONSTS_H
#define MESSAGE_SCHEMA_CONSTS_H
...
extern const char* CONNECTION_CREATE_NAME;
extern const char* CONNECTION_CREATE_PAYLOAD_SCHEMA_VERSION;
extern const char* CONNECTION_CREATE_PROCESS_ID_KEY;
extern const char* CONNECTION_CREATE_COMMAND_LINE_KEY;
extern const char* CONNECTION_CREATE_EXECUTABLE_KEY;
extern const char* CONNECTION_CREATE_USER_ID_KEY;
extern const char* CONNECTION_CREATE_PROTOCOL_KEY;
extern const char* CONNECTION_CREATE_PROTOCOL_TCP_NAME;
extern const char* CONNECTION_CREATE_PROTOCOL_UDP_NAME;
extern const char* CONNECTION_CREATE_PROTOCOL_ICMP_NAME;
extern const char* CONNECTION_CREATE_LOCAL_ADDRESS_KEY;
extern const char* CONNECTION_CREATE_LOCAL_PORT_KEY;
extern const char* CONNECTION_CREATE_REMOTE_ADDRESS_KEY;
extern const char* CONNECTION_CREATE_REMOTE_PORT_KEY;
extern const char* CONNECTION_CREATE_DIRECTION_KEY;
extern const char* CONNECTION_CREATE_DIRECTION_INBOUND_NAME;
extern const char* CONNECTION_CREATE_DIRECTION_OUTBOUND_NAME;
...
extern const char* DIAGNOSTIC_SEVERITY_INFO_VALUE;
...
extern const char* LISTENING_PORTS_STATE_KEY;
extern const char* LISTENING_PORTS_RECV_Q_KEY;
extern const char* LISTENING_PORTS_SEND_Q_KEY;
...
extern const char* HEARTBEAT_PAYLOAD_SCHEMA_VERSION;

#endif /* MESSAGE_SCHEMA_CONSTS_H */