...
const char* CONNECTION_CREATE_NAME = COLLECTOR_NAME_CONNECTION_CREATE;
const char* CONNECTION_CREATE_PAYLOAD_SCHEMA_VERSION = "1.0";
const char* CONNECTION_CREATE_EXECUTABLE_KEY = "Executable";
const char* CONNECTION_CREATE_COMMAND_LINE_KEY = "CommandLine";
const char* CONNECTION_CREATE_PROCESS_ID_KEY = "ProcessId";
const char* CONNECTION_CREATE_USER_ID_KEY = "UserId";
const char* CONNECTION_CREATE_PROTOCOL_KEY = "Protocol";
const char* CONNECTION_CREATE_PROTOCOL_TCP_NAME = "TCP";
const char* CONNECTION_CREATE_PROTOCOL_UDP_NAME = "UDP";
const char* CONNECTION_CREATE_PROTOCOL_ICMP_NAME = "ICMP";
const char* CONNECTION_CREATE_LOCAL_ADDRESS_KEY = "LocalAddress";
const char* CONNECTION_CREATE_LOCAL_PORT_KEY = "LocalPort";
const char* CONNECTION_CREATE_REMOTE_ADDRESS_KEY = "RemoteAddress";
const char* CONNECTION_CREATE_REMOTE_PORT_KEY = "RemotePort";
const char* CONNECTION_CREATE_DIRECTION_KEY = "Direction";
const char* CONNECTION_CREATE_DIRECTION_INBOUND_NAME = "In";
const char* CONNECTION_CREATE_DIRECTION_OUTBOUND_NAME = "Out";
...
const char* DIAGNOSTIC_SEVERITY_INFO_VALUE = "Information";
const char* DIAGNOSTIC_SEVERITY_WARNING_VALUE = "Warning";
const char* DIAGNOSTIC_SEVERITY_ERROR_VALUE = "Error";
const char* DIAGNOSTIC_SEVERITY_CRITICAL_VALUE = "Fatal";
...
const char* SYSTEM_INFORMATION_NAME = COLLECTOR_NAME_SYSTEM_INFORMATION;
...
const char* LISTENING_PORTS_NAME = COLLECTOR_NAME_LISTENING_PORTS;
...
const char* LISTENING_PORTS_STATE_KEY = "State";
const char* LISTENING_PORTS_RECV_Q_KEY = "Recv-Q";
const char* LISTENING_PORTS_SEND_Q_KEY = "Send-Q";
...
const char* HEARTBEAT_NAME = COLLECTOR_NAME_SYSTEM_INFORMATION;
const char* HEARTBEAT_PAYLOAD_SCHEMA_VERSION = "1.0";