...
typedef struct {
  ...
  OS_MUTEX read_lock;                       ///< read_lock. Available only when kernel present.
  OS_SEM read_signal;                       ///< read_signal. Available only when kernel present.
  OS_MUTEX write_lock;                      ///< write_lock. Available only when kernel present.
