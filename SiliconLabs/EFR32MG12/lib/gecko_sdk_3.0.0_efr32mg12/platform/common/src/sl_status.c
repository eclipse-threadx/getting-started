...
// Number of groups and strings per group for validation
static const uint8_t sli_status_group_table_length[] =
{
#if SL_STATUS_STRING_ENABLE_GENERIC == 1
  sizeof(sli_status_group_generic) / sizeof(char *),
#else
  0u,
#endif
  0u,
  ...
  0u,
#if SL_STATUS_STRING_ENABLE_BLUETOOTH == 1
  sizeof(sli_status_group_bluetooth) / sizeof(char *),
  sizeof(sli_status_group_bluetooth_mesh) / sizeof(char *),
#else
  0u,
  0u,
#endif
  ...
  0u,
#if SL_STATUS_STRING_ENABLE_WIFI == 1
  sizeof(sli_status_group_wifi) / sizeof(char *),
#else
  0u,
#endif
  0u,
  ...
  0u,
#if SL_STATUS_STRING_ENABLE_BLUETOOTH == 1
  sizeof(sli_status_group_bluetooth_ctrl) / sizeof(char *),
  sizeof(sli_status_group_bluetooth_att) / sizeof(char *),
  sizeof(sli_status_group_bluetooth_smp) / sizeof(char *),
  sizeof(sli_status_group_bluetooth_mesh_foundation) / sizeof(char *)
#else
  0u,
  0u,
  0u,
