...
#define SAMPLE_TX_PACKET_COUNT 12
...
/* Join Network.  */
static UINT wifi_network_join(void *pools, CHAR *ssid, CHAR *password, wiced_security_t security, wiced_country_code_t country)
{
