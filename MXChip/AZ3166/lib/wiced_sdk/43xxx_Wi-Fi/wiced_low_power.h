...
typedef enum
{
    WICED_LOW_POWER_ACTIVE,
    WICED_LOW_POWER_SLEEP,
    WICED_LOW_POWER_STOP,
    WICED_LOW_POWER_DEEP_SLEEP,
    WICED_LOW_POWER_HIBERNATE
} wiced_low_power_state_type_t;
...
typedef void ( *wiced_sleep_event_handler_t )( wiced_low_power_state_type_t state, wiced_sleep_event_type_t event, wiced_result_t* result );
...
#define WICED_SLEEP_EVENT_HANDLER( func_name ) \
    static void SECTION( WICED_SLEEP_SECTION_NAME_EVENT_HANDLER( func_name ) ) func_name( wiced_low_power_state_type_t state, wiced_sleep_event_type_t event, wiced_result_t* result ); \
    ...
    static void MAY_BE_UNUSED func_name( wiced_low_power_state_type_t state MAY_BE_UNUSED, wiced_sleep_event_type_t event , wiced_result_t* result MAY_BE_UNUSED )
#endif

void SECTION( WICED_SLEEP_SECTION_NAME_EVENT_HANDLER( wiced_sleep_call_event_handlers ) ) wiced_sleep_call_event_handlers( wiced_low_power_state_type_t state MAY_BE_UNUSED, wiced_sleep_event_type_t event, wiced_result_t* result MAY_BE_UNUSED );

#ifndef WICED_SLEEP_CALL_EVENT_HANDLERS
#define WICED_SLEEP_CALL_EVENT_HANDLERS( cond, state, event, result ) \
    do { if ( cond ) wiced_sleep_call_event_handlers( state, event, result ); } while( 0 )
#endif
...
#define WICED_SLEEP_EVENT_HANDLER( func_name ) \
    static IAR_ROOT_FUNC void MAY_BE_UNUSED func_name( wiced_low_power_state_type_t state MAY_BE_UNUSED, wiced_sleep_event_type_t event, wiced_result_t* result MAY_BE_UNUSED )
