 ...
 *
 * @param[in]  gpio    : The gpio pin which should be read
 * @param[out] value   : pointer to store gpio value of WICED_TRUE or WICED_FALSE
 *                          (only valid when result is WICED_SUCCESS)
 *
 * @return @ref wiced_result_t WICED_SUCCESS
 * @return @ref wiced_result_t error WICED_UNINITIALISED WICED_UNSUPPORTED
 */
